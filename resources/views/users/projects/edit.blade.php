            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                  <div class="container grid-layout drop-shadow-md bg-gray-500 p-3 mt-3 min-h-min">
                    <h1 class="font-bold text-3xl px-2">Edit Projects</h1>
                    ...
                    <div>
                        <form action="{{route('users.projects.update',$project->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="grid gap-6 mb-6 md:grid-cols-2">
                                <div class=" px-2 mt-6">
                                    <label for="title" class="block mb-2 text-sm font-medium text-white-700 dark:text-white-500">Title</label>
                                     <input type="text"  name="title" class="bg-green-50 border border-green-500 text-green-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500" value="{{ old('title', $project->title) }}" >
                                     @error('title')
                            ...
                            <div class="flex justify-center mt-6">
                                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"> Upadate</button>
